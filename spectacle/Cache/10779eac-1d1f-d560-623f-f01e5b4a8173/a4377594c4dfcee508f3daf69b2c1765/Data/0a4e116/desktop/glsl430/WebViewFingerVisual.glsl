...
uniform sc_Camera_t sc_Camera;
uniform float Port_Amount_N009;
uniform float Port_Exponent_N003;
uniform float Port_Intensity_N003;
uniform float Port_Input0_N010;
uniform float Port_Input0_N014;
uniform float Port_Input1_N014;
uniform vec3 Port_Input1_N013;
...
l9_3=l9_4.viewDirWS;
l9_2=(sc_ModelMatrixInverse*vec4(l9_4.positionWS,1.0)).xyz;
l9_1=l9_4.normalWS;
}
else
{
...
vec3 l9_5=-l9_3;
float l9_6=dot(l9_5,l9_1);
float l9_7=max(pow(1.0-abs(l9_6),Port_Exponent_N003),0.0)*Port_Intensity_N003;
vec3 l9_8=mix(mix(baseColor,mix(vec3(dot(baseColor,vec3(0.29899999,0.58700001,0.114))),baseColor,vec3(Port_Amount_N009)),vec3(Port_Input0_N010-l9_7)),Port_Input1_N013,vec3(mix(Port_Input0_N014,Port_Input1_N014,trigger)));
float l9_9=l9_2.x/(Port_Input1_N020+1.234e-06);
float l9_10=atan(l9_2.y,l9_2.z)*Port_Input1_N034;
float l9_11=(l9_9-Port_Input1_N018)*(((sin((l9_10*Port_Input1_N024)+(sc_Time.x*Port_Multiplier_N019))*Port_Input1_N023)+(l9_9+Port_Input1_N027))*((sin((l9_10*Port_Input1_N036)+(sc_Time.x*Port_Multiplier_N028))*Port_Input1_N032)+(l9_9+Port_Input1_N031)));
float l9_12=min(max(l9_7,mix(Port_Input0_N011,Port_Input1_N011,trigger))*alpha,l9_11);
vec4 l9_13=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_13.w=l9_12;
if (l9_8.x<step(l9_11,Port_Input1_N035))
{
discard;
}
...
#endif
sc_writeFragData0Internal(max(l9_14,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_16;
...
#if (sc_FramebufferFetch)
{
l9_31=sc_readFragData0_Platform();
}
#else
{
...
#endif
vec3 l9_34=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_13.xyz).xyz,vec3(l9_12));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_39=vec4(mix(vec3(1.0),l9_13.xyz,vec3(l9_12)),l9_12);
}
#else
{
vec4 l9_40;
...
vec4 l9_44=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_42,vec4(0.0)));
