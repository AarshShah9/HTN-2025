...
#endif
float l9_25=clamp(Port_Import_N045,0.0,1.0)*Port_Input1_N046;
int l9_26=sc_GetStereoViewIndex();
float l9_27=l9_25/(sc_ModelViewMatrixArray[l9_26][0].x+1.234e-06);
vec2 l9_28=abs(varPackedTex.xy-Port_Input1_N075);
float l9_29=l9_25/(sc_ModelViewMatrixArray[l9_26][1].y+1.234e-06);
float l9_30=l9_24.w*(smoothstep(Port_Input0_N078,Port_Input0_N073-min(gl_FragCoord.z*l9_27,l9_27),l9_28.x)*smoothstep(Port_Input0_N085,Port_Input0_N084-min(gl_FragCoord.z*l9_29,l9_29),l9_28.y));
vec4 l9_31=vec4(l9_24.x,l9_24.y,l9_24.z,vec4(0.0).w);
l9_31.w=l9_30;
...
#if (sc_FramebufferFetch)
{
l9_47=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_47=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_48,sc_ScreenTextureLayout,l9_49).xy,0.0);
}
#endif
vec3 l9_50=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_31.xyz).xyz,vec3(l9_30));
...
#if (sc_Voxelization)
{
l9_52=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_53;
#if (sc_OutputBounds)
{
float l9_54=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_53=vec4(l9_54,1.0-l9_54,1.0,1.0);
}
#else
{
vec4 l9_55;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_30)),l9_30);
}
#else
{
vec4 l9_56;
...
#endif
l9_56=vec4(l9_31.xyz*l9_57,l9_57);
}
#else
{
l9_56=l9_31;
...
vec4 l9_60=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_58,vec4(0.0)));
