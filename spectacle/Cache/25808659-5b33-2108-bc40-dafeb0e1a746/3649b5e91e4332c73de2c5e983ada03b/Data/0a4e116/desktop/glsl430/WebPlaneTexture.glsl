...
uniform mat4 sc_ModelViewMatrixArray[sc_NumStereoViews];
uniform float Port_Input0_N073;
uniform vec2 Port_Input1_N075;
uniform float Port_Input0_N078;
uniform float Port_Input0_N084;
uniform float Port_Input0_N085;
uniform int PreviewEnabled;
...
#endif
float l9_52=clamp(Port_Import_N045,0.0,1.0)*Port_Input1_N046;
int l9_53=sc_GetStereoViewIndex();
float l9_54=l9_52/(sc_ModelViewMatrixArray[l9_53][0].x+1.234e-06);
vec2 l9_55=l9_1-Port_Input1_N075;
vec2 l9_56=abs(l9_55);
float l9_57=l9_52/(sc_ModelViewMatrixArray[l9_53][1].y+1.234e-06);
float l9_58=l9_3.w*(smoothstep(Port_Input0_N078,Port_Input0_N073-min(gl_FragCoord.z*l9_54,l9_54),l9_56.x)*smoothstep(Port_Input0_N085,Port_Input0_N084-min(gl_FragCoord.z*l9_57,l9_57),l9_56.y));
vec4 l9_59=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_59.w=l9_58;
...
{
l9_65=clamp(dot(l9_59.xyz,vec3(l9_58)),0.0,1.0);
}
#else
{
float l9_66;
...
{
l9_67=(1.0-dot(l9_59.xyz,vec3(0.33333001)))*l9_58;
}
#else
{
float l9_68;
...
{
l9_68=(1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0))*l9_58;
}
#else
{
float l9_69;
...
{
l9_69=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*l9_58;
}
#else
{
float l9_70;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_71=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*l9_58;
}
#else
{
float l9_72;
...
{
l9_72=dot(l9_59.xyz,vec3(0.33333001))*l9_58;
}
#else
{
float l9_73;
...
{
l9_79=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_78,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_79=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_78,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_77=l9_79;
}
#endif
vec3 l9_80=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_59.xyz).xyz,vec3(l9_58));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_85=vec4(mix(vec3(1.0),l9_59.xyz,vec3(l9_58)),l9_58);
}
#else
{
vec4 l9_86;
...
#endif
l9_86=vec4(l9_59.xyz*l9_87,l9_87);
}
#else
{
l9_86=l9_59;
