...
// @input SpatialImage image
// @input AssignableType_1 loadingIndicator
// @input Asset.Texture[] gallery
// @input bool shuffle
...
awakeEvent.bind(() => {
    ...
    checkUndefined("loadingIndicator", []);
    checkUndefined("gallery", []);
    checkUndefined("shuffle", []);
    if (script.onAwake) {
       script.onAwake();
    }
});
