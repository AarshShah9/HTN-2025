...
let WebView = class WebView extends BaseScriptComponent {
    ...
    onAwake() {
        ...
        if (global.deviceInfoSystem.isSpectacles() && !global.deviceInfoSystem.isEditor()) {
            ...
            try {
                this.internetModule.createWebView(options, this.onWebViewCreated.bind(this), this.onWebViewCreationError.bind(this));
            }
            catch (e) {
    ...
    __initialize() {
        super.__initialize();
        this.internetModule = requireAsset("Web.internetModule");
