...
uniform float Port_Value1_N070;
uniform float Port_Value2_N070;
...
out float Interpolator_gStereoViewIndex;
...
vec3 l9_6=varNormal;
float l9_7=l9_5.z;
vec4 l9_8=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(0.0,0.0,((max(l9_7,-50.0)*depthScale)+frameOffset)+depthScale,1.0);
float l9_9=l9_8.w;
float l9_10=frameHeight/2.0;
vec4 l9_11=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(aspectRatio*l9_10,l9_10,frameOffset,1.0);
vec2 l9_12=l9_11.xy/vec2(l9_11.w);
vec4 l9_13=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4((-aspectRatio)*l9_10,-l9_10,frameOffset,1.0);
vec2 l9_14=l9_13.xy/vec2(l9_13.w);
vec2 l9_15=l9_5.xy/vec2(-l9_7);
float l9_16=l9_14.x;
float l9_17=l9_14.y;
vec4 l9_18=vec4((((l9_15.x+1.0)/2.0)*(l9_12.x-l9_16))+l9_16,(((l9_15.y+1.0)/2.0)*(l9_12.y-l9_17))+l9_17,l9_8.z/l9_9,l9_9);
vec3 l9_19=l9_18.xyz*l9_9;
vec4 l9_20=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_19.x,l9_19.y,l9_19.z,l9_18.w);
l9_20.w=1.0;
vec3 l9_21;
vec3 l9_22;
vec3 l9_23;
...
l9_23=varTangent.xyz;
l9_22=l9_6;
l9_21=(sc_ModelMatrix*vec4((sc_ModelMatrixInverse*vec4((sc_ModelMatrix*l9_20).xyz,1.0)).xyz-vec3(Port_Value1_N070,Port_Value2_N070,frameOffset),1.0)).xyz;
}
varPos=l9_21;
varNormal=normalize(l9_22);
vec3 l9_24=normalize(l9_23);
...
#if (sc_RenderingSpace==3)
{
l9_25=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_26;
#if (sc_RenderingSpace==2)
{
l9_26=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_27;
#if (sc_RenderingSpace==1)
{
l9_27=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_27=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_29=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_30;
#if (sc_RenderingSpace==2)
{
l9_30=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_31;
#if (sc_RenderingSpace==1)
{
l9_31=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_31=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_32=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_32=l9_0.position;
...
#endif
vec4 l9_33=sc_ProjectorMatrix*l9_32;
varShadowTex=((l9_33.xy/vec2(l9_33.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_34;
...
{
vec4 l9_36=l9_28;
l9_36.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_28.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_28.w;
l9_35=l9_36;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_38=l9_34.xy+(sc_TAAJitterOffset*l9_34.w);
l9_37=vec4(l9_38.x,l9_38.y,l9_34.z,l9_34.w);
}
#else
{
l9_37=l9_34;
...
#endif
sc_SetClipPosition(l9_37);
#if (sc_Voxelization)
{
sc_Vertex_t l9_39=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_39);
sc_SkinVertex(l9_39);
int l9_40=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_41=int(voxelization_params_0.w);
vec4 l9_42=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_39.position).xyz+vec3(float(l9_40%l9_41)*voxelization_params_0.y,float(l9_40/l9_41)*voxelization_params_0.y,(float(l9_40)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_42.w=1.0;
varScreenPos=l9_42;
...
#if (sc_OutputBounds)
{
sc_Vertex_t l9_43=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_3,l9_0.texture1);
sc_BlendVertex(l9_43);
sc_SkinVertex(l9_43);
vec2 l9_44=((l9_43.position.xy/vec2(l9_43.position.w))*0.5)+vec2(0.5);
varPackedTex=vec4(l9_44.x,l9_44.y,varPackedTex.z,varPackedTex.w);
vec4 l9_45=sc_ModelMatrixVoxelization*l9_43.position;
vec3 l9_46=l9_45.xyz-voxelization_params_camera_pos;
varPos=l9_46.xyz;
varNormal=normalize(l9_43.normal);
vec4 l9_47=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_46.x,l9_46.y,l9_46.z,l9_45.w);
vec4 l9_48=vec4(l9_47.x,l9_47.y,l9_47.z,vec4(0.0).w);
l9_48.w=1.0;
varScreenPos=l9_48;
sc_SetClipPosition(l9_48*1.0);
}
#endif
}
#endif
Interpolator0.x=l9_5.x;
Interpolator0.y=l9_5.y;
Interpolator0.z=l9_7;
Interpolator_gStereoViewIndex=float(sc_StereoViewID);
}
...
uniform float aspectRatio;
uniform sc_Camera_t sc_Camera;
uniform float Port_eyeOffset_N060;
uniform float Port_Input1_N037;
uniform float fadeSpeed;
uniform float Port_Default_N045;
uniform float cornerRadius;
uniform mat3 baseTexTransform;
uniform vec4 baseTexUvMinMax;
uniform vec4 baseTexBorderColor;
uniform float Port_Default_N116;
...
in float Interpolator_gStereoViewIndex;
in vec3 varPos;
in vec3 varNormal;
in vec4 varTangent;
...
vec2 N7_getTopRightNDCxy(float height,float N7_aspect,float offset)
{
float l9_0=height/2.0;
vec4 l9_1=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(N7_aspect*l9_0,l9_0,offset,1.0);
return (l9_1.xy/vec2(l9_1.w)).xy;
}
vec2 N7_getBottomLeftNDCxy(float height,float N7_aspect,float offset)
{
float l9_0=height/2.0;
vec4 l9_1=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4((-N7_aspect)*l9_0,-l9_0,offset,1.0);
return (l9_1.xy/vec2(l9_1.w)).xy;
...
#endif
vec3 l9_49=vec3(l9_0.xyz);
float l9_50;
if ((clamp(float(fadeBorder),0.0,1.0)*1.0)!=0.0)
{
vec3 l9_51=vec3(Interpolator0.x,Interpolator0.y,Interpolator0.z);
vec3 l9_52=abs(l9_51);
vec2 l9_53=l9_52.xy/(vec2(l9_52.z)+vec2(1.234e-06));
float l9_54;
if ((float(frameOn)*1.0)!=0.0)
{
vec4 l9_55=sc_ModelMatrixInverse*vec4(sc_Camera.position+((sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz*((float(int(Interpolator_gStereoViewIndex))-0.5)*2.0))*Port_eyeOffset_N060),1.0);
vec3 l9_56=l9_55.xyz;
vec4 l9_57=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(0.0,0.0,((max(Interpolator0.z,-50.0)*depthScale)+frameOffset)+depthScale,1.0);
float l9_58=l9_57.w;
vec2 l9_59=N7_getTopRightNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_60=N7_getBottomLeftNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_61=l9_51.xy/vec2(-Interpolator0.z);
float l9_62=l9_60.x;
float l9_63=l9_60.y;
vec4 l9_64=vec4((((l9_61.x+1.0)/2.0)*(l9_59.x-l9_62))+l9_62,(((l9_61.y+1.0)/2.0)*(l9_59.y-l9_63))+l9_63,l9_57.z/l9_58,l9_58);
vec3 l9_65=l9_64.xyz*l9_58;
vec4 l9_66=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_65.x,l9_65.y,l9_65.z,l9_64.w);
l9_66.w=1.0;
vec3 l9_67=(sc_ModelMatrixInverse*vec4((sc_ModelMatrix*l9_66).xyz,1.0)).xyz;
float l9_68=l9_55.z;
vec2 l9_69=abs(vec2((((l9_56-l9_67)*vec3(l9_68/(((l9_67-vec3(0.0,0.0,frameOffset)).z-l9_68)+1.234e-06)))+l9_56).xy))/((vec2(aspectRatio*frameHeight,frameHeight)*vec2(Port_Input1_N037))+vec2(1.234e-06));
l9_54=max(l9_69.x,l9_69.y);
}
else
{
l9_54=Port_Default_N045;
}
float l9_70=max(max(l9_53.x,l9_53.y),l9_54);
float l9_71;
if (l9_70<=0.0)
{
l9_71=0.0;
...
{
l9_71=pow(l9_70,fadeSpeed);
}
l9_50=1.0-l9_71;
}
else
{
l9_50=Port_Default_N116;
}
vec4 l9_72=vec4(l9_49.x,l9_49.y,l9_49.z,vec4(0.0).w);
l9_72.w=l9_50;
vec4 l9_73=sc_ModelMatrixInverse*vec4(sc_Camera.position+((sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz*((float(int(Interpolator_gStereoViewIndex))-0.5)*2.0))*Port_eyeOffset_N060),1.0);
vec3 l9_74=l9_73.xyz;
float l9_75=l9_73.z;
if ((float(l9_75<Port_Input1_N033)*1.0)!=0.0)
{
discard;
}
vec4 l9_76=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(0.0,0.0,((max(Interpolator0.z,-50.0)*depthScale)+frameOffset)+depthScale,1.0);
float l9_77=l9_76.w;
vec2 l9_78=N7_getTopRightNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_79=N7_getBottomLeftNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_80=vec3(Interpolator0.x,Interpolator0.y,Interpolator0.z).xy/vec2(-Interpolator0.z);
float l9_81=l9_79.x;
float l9_82=l9_79.y;
vec4 l9_83=vec4((((l9_80.x+1.0)/2.0)*(l9_78.x-l9_81))+l9_81,(((l9_80.y+1.0)/2.0)*(l9_78.y-l9_82))+l9_82,l9_76.z/l9_77,l9_77);
vec3 l9_84=l9_83.xyz*l9_77;
vec4 l9_85=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_84.x,l9_84.y,l9_84.z,l9_83.w);
l9_85.w=1.0;
vec3 l9_86=(sc_ModelMatrixInverse*vec4((sc_ModelMatrix*l9_85).xyz,1.0)).xyz;
vec2 l9_87=abs(vec2((((l9_74-l9_86)*vec3(l9_75/(((l9_86-vec3(0.0,0.0,frameOffset)).z-l9_75)+1.234e-06)))+l9_74).xy));
vec2 l9_88=vec2(aspectRatio*frameHeight,frameHeight)*vec2(Port_Input1_N037);
float l9_89=l9_87.x;
float l9_90=l9_87.y;
bool l9_91=(float(l9_89>l9_88.x)*1.0)!=0.0;
bool l9_92;
if (!l9_91)
{
l9_92=(float(l9_90>l9_88.y)*1.0)!=0.0;
}
else
{
l9_92=l9_91;
}
float l9_93=float(l9_92);
vec2 l9_94=l9_88-vec2(cornerRadius);
bool l9_95=(float(l9_89>l9_94.x)*1.0)!=0.0;
bool l9_96;
if (l9_95)
{
l9_96=(float(l9_90>l9_94.y)*1.0)!=0.0;
}
else
{
l9_96=l9_95;
}
float l9_97=float(l9_96);
bool l9_98=(l9_97*1.0)!=0.0;
bool l9_99;
if (l9_98)
{
l9_99=(float(distance(l9_87,l9_94)>cornerRadius)*1.0)!=0.0;
}
else
{
l9_99=l9_98;
}
float l9_100=float(l9_99);
bool l9_101=(l9_93*1.0)!=0.0;
bool l9_102;
if (!l9_101)
{
l9_102=(l9_100*1.0)!=0.0;
}
else
{
l9_102=l9_101;
...
bool l9_104=(l9_103*1.0)!=0.0;
bool l9_105;
if (l9_104)
{
l9_105=(float(frameOn)*1.0)!=0.0;
}
else
{
l9_105=l9_104;
}
if ((float(l9_105)*1.0)!=0.0)
{
discard;
}
...
{
l9_108=clamp(l9_50*2.0,0.0,1.0);
}
#else
{
float l9_109;
...
{
l9_109=clamp(dot(l9_72.xyz,vec3(l9_50)),0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_111=(1.0-dot(l9_72.xyz,vec3(0.33333001)))*l9_50;
}
#else
{
float l9_112;
...
{
l9_112=(1.0-clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0))*l9_50;
}
#else
{
float l9_113;
...
{
l9_113=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_114;
#if (sc_BlendMode_Add)
{
l9_114=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_115;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_115=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_116;
...
{
l9_116=dot(l9_72.xyz,vec3(0.33333001))*l9_50;
}
#else
{
float l9_117;
#if (sc_BlendMode_Min)
{
l9_117=1.0-clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_118;
#if (sc_BlendMode_Max)
{
l9_118=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_118=1.0;
...
#endif
l9_106=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_72.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_107);
}
#else
{
vec4 l9_119;
...
#if (sc_FramebufferFetch)
{
l9_121=sc_readFragData0_Platform();
}
#else
{
...
{
l9_123=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_123=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_121=l9_123;
}
#endif
vec3 l9_124=mix(l9_121.xyz,definedBlend(l9_121.xyz,l9_72.xyz).xyz,vec3(l9_50));
...
#if (sc_Voxelization)
{
l9_126=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_127;
#if (sc_OutputBounds)
{
float l9_128=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_127=vec4(l9_128,1.0-l9_128,1.0,1.0);
}
#else
{
vec4 l9_129;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_129=vec4(mix(vec3(1.0),l9_72.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_130;
...
#endif
l9_130=vec4(l9_72.xyz*l9_131,l9_131);
}
#else
{
l9_130=l9_72;
...
vec4 l9_134=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_132,vec4(0.0)));
vec4 l9_135=clamp(l9_134,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_136=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_136-0.0039215689)),min(1.0,l9_136+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_137).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_138=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_137).xy);
float l9_139=packValue(l9_138);
int l9_146=int(l9_135.w*255.0);
float l9_147=packValue(l9_146);
sc_writeFragData0Internal(vec4(packValue(l9_138),packValue(l9_138),packValue(l9_138),packValue(l9_138)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_139,packValue(l9_138),packValue(l9_138),packValue(l9_138)));
sc_writeFragData2(vec4(l9_147,packValue(l9_146),packValue(l9_146),packValue(l9_146)));
...
if (l9_155==0)
{
l9_158=texture(sc_OITAlpha0,l9_150);
l9_157=texture(sc_OITDepthLow0,l9_150);
l9_156=texture(sc_OITDepthHigh0,l9_150);
}
else
{
l9_158=vec4(0.0);
...
if (l9_155==1)
{
l9_161=texture(sc_OITAlpha1,l9_150);
l9_160=texture(sc_OITDepthLow1,l9_150);
l9_159=texture(sc_OITDepthHigh1,l9_150);
}
else
{
l9_161=l9_158;
...
if (any(notEqual(l9_159,vec4(0.0)))||any(notEqual(l9_160,vec4(0.0))))
{
int l9_162[8]=l9_151;
unpackValues(l9_159.w,l9_155,l9_162);
unpackValues(l9_159.z,l9_155,l9_162);
unpackValues(l9_159.y,l9_155,l9_162);
unpackValues(l9_159.x,l9_155,l9_162);
unpackValues(l9_160.w,l9_155,l9_162);
unpackValues(l9_160.z,l9_155,l9_162);
unpackValues(l9_160.y,l9_155,l9_162);
unpackValues(l9_160.x,l9_155,l9_162);
int l9_171[8]=l9_152;
unpackValues(l9_161.w,l9_155,l9_171);
unpackValues(l9_161.z,l9_155,l9_171);
unpackValues(l9_161.y,l9_155,l9_171);
unpackValues(l9_161.x,l9_155,l9_171);
}
l9_155++;
continue;
}
...
vec4 l9_176=texture(sc_OITFilteredDepthBoundsTexture,l9_150);
vec2 l9_177=l9_176.xy;
int l9_178;
#if (sc_SkinBonesCount>0)
{
l9_178=encodeDepth(((1.0-l9_176.x)*1000.0)+getDepthOrderingEpsilon(),l9_177);
}
#else
{
l9_178=0;
...
#endif
int l9_179=encodeDepth(viewSpaceDepth(),l9_177);
vec4 l9_180;
l9_180=l9_135*l9_135.w;
vec4 l9_181;
int l9_182=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_182<8)
{
int l9_183=l9_151[l9_182];
int l9_184=l9_179-l9_178;
bool l9_185=l9_183<l9_184;
bool l9_186;
if (l9_185)
{
l9_186=l9_151[l9_182]>0;
}
else
{
l9_186=l9_185;
...
if (l9_186)
{
vec3 l9_187=l9_180.xyz*(1.0-(float(l9_152[l9_182])/255.0));
l9_181=vec4(l9_187.x,l9_187.y,l9_187.z,l9_180.w);
}
else
{
l9_181=l9_180;
