...
varying float Interpolator_gStereoViewIndex;
...
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),baseTexLayout,l9_0);
...
#endif
vec3 l9_25=vec3(l9_24.xyz);
float l9_26;
if ((clamp(float(fadeBorder),0.0,1.0)*1.0)!=0.0)
{
vec3 l9_27=vec3(Interpolator0.x,Interpolator0.y,Interpolator0.z);
vec3 l9_28=abs(l9_27);
vec2 l9_29=l9_28.xy/(vec2(l9_28.z)+vec2(1.234e-06));
float l9_30;
if ((float(frameOn)*1.0)!=0.0)
{
vec4 l9_31=sc_ModelMatrixInverse*vec4(sc_Camera.position+((sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz*((float(int(Interpolator_gStereoViewIndex))-0.5)*2.0))*Port_eyeOffset_N060),1.0);
vec3 l9_32=l9_31.xyz;
vec4 l9_33=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(0.0,0.0,((max(Interpolator0.z,-50.0)*depthScale)+frameOffset)+depthScale,1.0);
float l9_34=l9_33.w;
vec2 l9_35=N7_getTopRightNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_36=N7_getBottomLeftNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_37=l9_27.xy/vec2(-Interpolator0.z);
float l9_38=l9_36.x;
float l9_39=l9_36.y;
vec4 l9_40=vec4((((l9_37.x+1.0)/2.0)*(l9_35.x-l9_38))+l9_38,(((l9_37.y+1.0)/2.0)*(l9_35.y-l9_39))+l9_39,l9_33.z/l9_34,l9_34);
vec3 l9_41=l9_40.xyz*l9_34;
vec4 l9_42=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_41.x,l9_41.y,l9_41.z,l9_40.w);
l9_42.w=1.0;
vec3 l9_43=(sc_ModelMatrixInverse*vec4((sc_ModelMatrix*l9_42).xyz,1.0)).xyz;
float l9_44=l9_31.z;
vec2 l9_45=abs(vec2((((l9_32-l9_43)*vec3(l9_44/(((l9_43-vec3(0.0,0.0,frameOffset)).z-l9_44)+1.234e-06)))+l9_32).xy))/((vec2(aspectRatio*frameHeight,frameHeight)*vec2(Port_Input1_N037))+vec2(1.234e-06));
l9_30=max(l9_45.x,l9_45.y);
}
else
{
l9_30=Port_Default_N045;
}
float l9_46=max(max(l9_29.x,l9_29.y),l9_30);
float l9_47;
if (l9_46<=0.0)
{
l9_47=0.0;
...
{
l9_47=pow(l9_46,fadeSpeed);
}
l9_26=1.0-l9_47;
}
else
{
l9_26=Port_Default_N116;
}
vec4 l9_48=vec4(l9_25.x,l9_25.y,l9_25.z,vec4(0.0).w);
l9_48.w=l9_26;
vec4 l9_49=sc_ModelMatrixInverse*vec4(sc_Camera.position+((sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][0].xyz*((float(int(Interpolator_gStereoViewIndex))-0.5)*2.0))*Port_eyeOffset_N060),1.0);
vec3 l9_50=l9_49.xyz;
float l9_51=l9_49.z;
if ((float(l9_51<Port_Input1_N033)*1.0)!=0.0)
{
discard;
}
vec4 l9_52=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(0.0,0.0,((max(Interpolator0.z,-50.0)*depthScale)+frameOffset)+depthScale,1.0);
float l9_53=l9_52.w;
vec2 l9_54=N7_getTopRightNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_55=N7_getBottomLeftNDCxy(frameHeight,aspectRatio,frameOffset);
vec2 l9_56=vec3(Interpolator0.x,Interpolator0.y,Interpolator0.z).xy/vec2(-Interpolator0.z);
float l9_57=l9_55.x;
float l9_58=l9_55.y;
vec4 l9_59=vec4((((l9_56.x+1.0)/2.0)*(l9_54.x-l9_57))+l9_57,(((l9_56.y+1.0)/2.0)*(l9_54.y-l9_58))+l9_58,l9_52.z/l9_53,l9_53);
vec3 l9_60=l9_59.xyz*l9_53;
vec4 l9_61=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_60.x,l9_60.y,l9_60.z,l9_59.w);
l9_61.w=1.0;
vec3 l9_62=(sc_ModelMatrixInverse*vec4((sc_ModelMatrix*l9_61).xyz,1.0)).xyz;
vec2 l9_63=abs(vec2((((l9_50-l9_62)*vec3(l9_51/(((l9_62-vec3(0.0,0.0,frameOffset)).z-l9_51)+1.234e-06)))+l9_50).xy));
vec2 l9_64=vec2(aspectRatio*frameHeight,frameHeight)*vec2(Port_Input1_N037);
float l9_65=l9_63.x;
float l9_66=l9_63.y;
bool l9_67=(float(l9_65>l9_64.x)*1.0)!=0.0;
bool l9_68;
if (!l9_67)
{
l9_68=(float(l9_66>l9_64.y)*1.0)!=0.0;
}
else
{
l9_68=l9_67;
}
float l9_69=float(l9_68);
vec2 l9_70=l9_64-vec2(cornerRadius);
bool l9_71=(float(l9_65>l9_70.x)*1.0)!=0.0;
bool l9_72;
if (l9_71)
{
l9_72=(float(l9_66>l9_70.y)*1.0)!=0.0;
}
else
{
l9_72=l9_71;
...
bool l9_74=(l9_73*1.0)!=0.0;
bool l9_75;
if (l9_74)
{
l9_75=(float(distance(l9_63,l9_70)>cornerRadius)*1.0)!=0.0;
}
else
{
l9_75=l9_74;
...
float l9_79=float(l9_78);
bool l9_80=(l9_79*1.0)!=0.0;
bool l9_81;
if (l9_80)
{
l9_81=(float(frameOn)*1.0)!=0.0;
}
else
{
l9_81=l9_80;
}
if ((float(l9_81)*1.0)!=0.0)
{
discard;
}
...
{
l9_85=clamp(dot(l9_48.xyz,vec3(l9_26)),0.0,1.0);
}
#else
{
float l9_86;
...
{
l9_87=(1.0-dot(l9_48.xyz,vec3(0.33333001)))*l9_26;
}
#else
{
float l9_88;
...
{
l9_88=(1.0-clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0))*l9_26;
}
#else
{
float l9_89;
...
{
l9_89=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_90;
#if (sc_BlendMode_Add)
{
l9_90=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_91=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_92;
...
{
l9_92=dot(l9_48.xyz,vec3(0.33333001))*l9_26;
}
#else
{
float l9_93;
#if (sc_BlendMode_Min)
{
l9_93=1.0-clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_94;
#if (sc_BlendMode_Max)
{
l9_94=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_94=1.0;
...
#endif
l9_82=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_48.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_83);
}
#else
{
vec4 l9_95;
...
#if (sc_FramebufferFetch)
{
l9_97=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_97=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_98,sc_ScreenTextureLayout,l9_99).xy,0.0);
}
#endif
vec3 l9_100=mix(l9_97.xyz,definedBlend(l9_97.xyz,l9_48.xyz).xyz,vec3(l9_26));
...
#if (sc_Voxelization)
{
l9_102=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_103;
#if (sc_OutputBounds)
{
float l9_104=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_103=vec4(l9_104,1.0-l9_104,1.0,1.0);
}
#else
{
vec4 l9_105;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_105=vec4(mix(vec3(1.0),l9_48.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_106;
...
#endif
l9_106=vec4(l9_48.xyz*l9_107,l9_107);
}
#else
{
l9_106=l9_48;
...
vec4 l9_110=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_108,vec4(0.0)));
