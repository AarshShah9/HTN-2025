...
export class AudioVideo extends BaseScriptComponent {
    ...
    private uploadEveryNFrames: number = 300;
    ...
    private videoBufferSize: number = 1;
    ...
    private async uploadFramesWithAudio(frames: string[], audioData: Float32Array) {
        ...
        try {
            await this.internetModule.fetch(new Request('https://14954ff762b6.ngrok-free.app/image', {
                method: 'POST',
    ...
    private async sendVideoBuffer() {
        ...
        try {
            ...
            await this.internetModule.fetch(new Request('https://14954ff762b6.ngrok-free.app/video', {
                method: 'POST',
                headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning": "plswork" },
                body
            }));
