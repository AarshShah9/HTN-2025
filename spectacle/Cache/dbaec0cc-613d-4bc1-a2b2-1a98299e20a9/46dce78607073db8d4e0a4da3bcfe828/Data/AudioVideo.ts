...
export class AudioVideo extends BaseScriptComponent {
    ...
    private async uploadFramesWithAudio(frames: string[], audioData: Float32Array) {
        ...
        print(typeof frames[0] + "wtsfadsf");
        print(typeof audio[0] + "wtsfadsWTFf");
        ...
        try {
            await this.internetModule.fetch(new Request('http://127.0.0.1:5000/image', {
                method: 'POST',
    ...
    private async sendVideoBuffer() {
        ...
        try {
            ...
            print(typeof framesCopy[0] + "wtsfadsf");
