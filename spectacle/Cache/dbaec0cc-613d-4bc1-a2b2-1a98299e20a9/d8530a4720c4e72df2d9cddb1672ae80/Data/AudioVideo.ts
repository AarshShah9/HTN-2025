...
export class AudioVideo extends BaseScriptComponent {
    ...
    @input uploadEveryNFrames: number = 15000; // increased to 3000
    ...
    private async uploadFramesWithAudio(frames: string[], audioData: Float32Array) {
        ...
        try {
            await this.internetModule.fetch(new Request('http://10.37.114.197:8000/video', {
                method: 'POST',
    ...
    private async sendVideoBuffer() {
        ...
        try {
            ...
            await this.internetModule.fetch(new Request('http://10.37.113.66:5000/replay', {
                method: 'POST',
                headers: { "Content-Type": "application/json" },
                body
            }));
